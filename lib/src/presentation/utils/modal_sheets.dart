...
/// custom exit dialog
Future<bool> exitDialog({required context, required contentKey, Widget? customExistDialog, 
String strDiscardTitle = "Discard Edits?",
String strDiscardAlert="if you go back now, you'll lose all th edits you've made.",
String strDiscardBtn="Discard",
String strSaveDraftBtn = "Save Draft",
String strCancelBtn = "Cancel",
