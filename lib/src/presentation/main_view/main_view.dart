...
class MainView extends StatefulWidget {
  ...
  final Widget? customExistDialog;

  final String customIntroText;
  final String? strDiscardTitle;
  final String? strDiscardAlert;
  final String? strDiscardBtn;
  final String? strSaveDraftBtn;
  final String? strCancelBtn;
  //Test version ben
  ...
  MainView(
      ...
      this.customExistDialog,
      this.customIntroText = "Tap to type",
      this.strCancelBtn,
      this.strDiscardAlert,
      this.strDiscardBtn,
      this.strDiscardTitle,
      this.strSaveDraftBtn
      })
      : super(key: key);
...
class _MainViewState extends State<MainView> {
                            ...
                            if (itemProvider.draggableWidget.isEmpty && !controlNotifier.isTextEditing && paintingProvider.lines.isEmpty)
                              IgnorePointer(
                                ...
                                child: Align(
                                  ...
                                  child: Text(widget.customIntroText,
                                      style: TextStyle(
                                          fontFamily: 'Alegreya',
  ...
  Future<bool> _popScope() async {
    ...
    /// show close dialog
      ...
      return widget.onBackPress ?? exitDialog(context: context, contentKey: contentKey, customExistDialog: widget.customExistDialog, 
       strDiscardTitle: widget.strDiscardTitle!,
       strDiscardAlert: widget.strDiscardAlert!,
       strDiscardBtn: widget.strDiscardBtn!,
       strSaveDraftBtn: widget.strSaveDraftBtn!,
       strCancelBtn: widget.strCancelBtn!,
       );
    }
    return false;
  }
